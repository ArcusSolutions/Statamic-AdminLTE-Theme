<section class="content-header">
    <h1>
        Dashboard
        <small>Statamic Control Panel</small>
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
    ...
    <div class="box box-success">
        ...
        <div class="box-body chat" id="chat-box">
            <!-- chat item -->
            <div class="item">
                <img src="<?php echo Path::tidy(Config::getSiteRoot().'/'.$app->config['theme_path']) ?>img/avatar.png" alt="user image" class="online"/>
                <p class="message">
                    <a href="#" class="name">
            ...
            <!-- chat item -->
            <div class="item">
                <img src="<?php echo Path::tidy(Config::getSiteRoot().'/'.$app->config['theme_path']) ?>img/avatar2.png" alt="user image" class="offline"/>
                <p class="message">
                    <a href="#" class="name">
            ...
            <!-- chat item -->
            <div class="item">
                <img src="<?php echo Path::tidy(Config::getSiteRoot().'/'.$app->config['theme_path']) ?>img/avatar3.png" alt="user image" class="offline"/>
                <p class="message">
                    <a href="#" class="name">
